...
interface SupplierFormFieldsProps {
  ...
  onChange: <K extends keyof SupplierInput>(key: K, value: SupplierInput[K]) => void;
}

export function SupplierFormFields({ form, errors, onChange }: SupplierFormFieldsProps) {
  return (
